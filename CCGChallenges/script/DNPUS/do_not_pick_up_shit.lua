...
local DNPUS_MCM = {
    ...
    en = {
        ...
        K0 = "Amount of shits spawned in every uncleared standard-sized room",
        N1 = "Per-Floor shit Bonus:",
        K1 = "Extra shit added to each room for every floor cleared",
        N2 = "Room Size Multiplier",
        K2 = "For example, a 2x2 large room spawns 4 times as many shits as a standard room",
